...
Router.prototype.getRouter = function() {
  let router;
  try {
    const node = this.findInReact(this.getReact(document.querySelector('#root div')), n => n.stateNode && n.stateNode.context && n.stateNode.context.router);
